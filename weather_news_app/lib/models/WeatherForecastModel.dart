class WeatherForecastModel {
  ...
  double message;
  int cnt;
  List<WeatherConditionDetails> list;
  ...
  WeatherForecastModel.fromJson(Map<String, dynamic> json) {
    ...
    cnt = json['cnt'];
    if (json['list'] != null) {
      list = new List<WeatherConditionDetails>();
      json['list'].forEach((v) {
        list.add(new WeatherConditionDetails.fromJson(v));
      });
    }
  }
...
class WeatherConditionDetails {
  ...
  WeatherConditionDetails.fromJson(Map<String, dynamic> json) {
    dt = json['dt'];
